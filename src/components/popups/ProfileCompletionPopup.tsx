...
export default function ProfileCompletionPopup({
  ...
  const validateForm = () => {
    ...
    if (!formData.dealershipAddress.trim())
      newErrors.dealershipAddress = 'Dealership address is required';
      ...
      <div className="bg-white rounded-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          <p className="text-gray-600 mb-6">
            To continue enjoying your free account, please provide some additional information about
            yourself and your dealership.
          </p>
