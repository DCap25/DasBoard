...
export const ROLE_PERMISSIONS = {
  salesperson: ['view_own_sales', 'create_sale', 'view_own_dealership', 'view_own_metrics'],
  finance_manager: [
  ...
  admin: ['view_all_data', 'manage_dealerships', 'manage_users', 'manage_roles', 'manage_system'],
};
 ...
 */
export function filterEntitiesByAccess<
  T extends { dealership_id?: string | null; user_id?: string | null },
>(user: User | null, entities: T[]): T[] {
  if (!user) return [];
